...
public class level_3 implements Initializable{
	...
	public void initialize(java.net.URL arg0, ResourceBundle arg1) {
		...
		for(int i = 0;i<levelDetail.level3BricksNumber;i++)
			brickList.add(new brick(levelDetail.level3BricksX[i],levelDetail.level3BricksY[i]));
		for(int i=0;i<levelDetail.level3BricksNumber;i++) BrickPane.getChildren().add(brickList.get(i).brick);
		newBall=new ball();
	...
	private void setNextFrame() {
		...
		if(isdie) {
			...
			try {
				...
				controller.passValue(3,totalScore, HP,bigTimer.get(),false);
	...
	public void win() throws IOException {
		...
		resultController controller=loader.getController();
		controller.passValue(3,totalScore, HP,bigTimer.get(),true);
		Scene resultScene=new Scene(result);
		resultScene.getRoot().requestFocus();
		welcome.currentStage.setScene(resultScene);
	}
